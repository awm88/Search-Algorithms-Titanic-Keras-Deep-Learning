# -*- coding: utf-8 -*-
"""
Created on Sun Sep 26 00:18:40 2021
...
# This shows the mean, stdev, min, and max of each category
# DATA ANALYSIS
...
# %% [code]
# This shows correlation to find useful variables
train_df.corr()
# %% [markdown]
...
# %% [markdown]
# This graph shows that both males and females in the 3rd class were more likely to die compared to being in first or second class.
# The number of females who did not survive in the first class is very low. This graph shows the 2 most highly correlated factors with survival so its an important graph.
...
fig = plt.gcf()
# pyplot. gcf() is primarily used to get the current figure.
...
# %% [markdown]
# This shows that most people who embarked from C survive, with Q being second and S being third.
# I chose to fill in with C because there are more upper class people from C and the missing values are upper class people.
...
# %% [markdown]
# We already know class has correlation with survival.
# Now its clear that females are more likely to survive in every class compared to males, and both genders are more likely to survive in first class, and then second class, and then third class.
